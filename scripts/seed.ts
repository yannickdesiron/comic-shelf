 ...
 * albums so the shelf has something to show. Generates a simple two-tone
...
const seeds: Seed[] = [
  ...
  { seriesTitle: "Suske en Wiske", number: "140", title: "De Zwarte Madam", publisher: "Standaard Uitgeverij", year: "1973", readStatus: "unread", location: "Kast woonkamer, plank 1", palette: ["#251c19", "#efe5cf"] },
  ...
  { seriesTitle: "Kuifje", title: "De Zaak Zonnebloem", publisher: "Casterman", year: "1956", format: "hardcover", readStatus: "unread", location: "Kast bureau", palette: ["#c7a26b", "#1f1a17"] },
  ...
  { seriesTitle: "Franka", number: "1", title: "Het Misdaadmuseum", publisher: "Oberon", year: "1978", readStatus: "unread", location: "Doos zolder", palette: ["#b23a48", "#fcf6f5"] },
